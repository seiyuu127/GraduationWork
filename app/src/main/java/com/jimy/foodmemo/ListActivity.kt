...
//リスト項目をクリックした時にCreateMemoActivity.ktに遷移する処理
//データベースに保存したデータを特定するためのIDをクリック時に送信する
class ListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val c = db.rawQuery("select uuid, body from FOOD_TABLE order by id", null)
            // Cursorの先頭行があるかどうか確認
        ...
        listView.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
            ...
            val intent = Intent(this@ListActivity, com.jimy.foodmemo.CreateMemoActivity::class.java)
